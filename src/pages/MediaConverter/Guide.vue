          ...
          >
            <div class="pb-10 mb-10 border-b border-gray-200">
              ...
              <p class="mt-1 text-lg text-gray-500">
                Easily and quickly integrate your application with AWS MediaConvert.
              </p>
            </div>
            <div>
              <div class="prose">
                ...
                <div>
                  <pre v-highlightjs="sourcecode"><code class="bash">composer require meema/laravel-media-converter</code></pre>
                </div>
                ...
                <div>
                  ...
                  <div>
                    <pre v-highlightjs="sourcecode"><code class="bash">use Meema\MediaConverter\Facades\MediaConvert;
...
dispatch(new CreateVideoConversion($jobSettings, $mediaId)); // $mediaId is optional & refers to the relating model's id</code></pre>
                  </div>
                  <div class="mt-4">
                  ...
                  <div>
                    <pre v-highlightjs="sourcecode"><code class="bash">php artisan vendor:publish --provider="Meema\MediaConverter\Providers\MediaConvertServiceProvider" --tag="config"</code></pre>
                  </div>
...
AWS_QUEUE_ARN=arn:aws:mediaconvert:us-east-1:xxxxxxx:queues/Default</code></pre>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div class="ml-8">
                      <ul class="list-decimal">
                        ...
                        <li>
                          For Topic name, enter <span class="code-highlight">MediaConvertJobUpdate</span>, and then choose "Create topic".
                          <img src="https://camo.githubusercontent.com/68b64020fcedba3288e86b4789cfd40e2def2fef876584aefef461a5a083050b/68747470733a2f2f692e696d6775722e636f6d2f777a564a46785a2e706e67" alt="" />
                        </li>
                        <li>
                          Choose the topic ARN link for the topic that you just created. It looks something like this:
                          <span class="code-highlight">arn:aws:sns:region:123456789012:MediaConvertJobUpdate.</span>
                        </li>
                        <li>
                          On the Topic details:
                          <span class="code-highlight">MediaConvertJobUpdate page</span>,  
                        ...
                        <li>
                          ...
                          <p>For example,</p>
                          <p>
                            <pre v-highlightjs="sourcecode"><code class="plaintext">https://meema-api.sharedwithexpose.com/api/webhooks/media-converter</code></pre>
                          </p>
                        </li>
                  ...
                  <div class="mt-4">
                    <p>
                      ...
                      navigating to the <span class="code-highlight">MediaConvertJobUpdate</span> Topic page.
                      There, you should see the following section:
                      <img src="https://camo.githubusercontent.com/ae8575a3ad7a596b41bd72141e9f0fe287b28c3414dbf037eda0106fc8c67e21/68747470733a2f2f692e696d6775722e636f6d2f717a4c5a4a41442e706e67" alt="">
                    </p>
                    <p>
